...
RELEASE_ID=`curl -i -X POST -H "Content-Type:application/json" -H "Authorization: token $GITHUB_BOT_TOKEN" https://api.github.com/repos/pdulvp/jellyfin-qnap/releases -d "{\"tag_name\":\"$1\", \"target_commitish\":\"master\",\"name\": \"$2\", \"body\": \"$3\", \"draft\": false, \"prerelease\": $5}" `
echo "$RELEASE_ID"
